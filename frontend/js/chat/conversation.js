...
var ConversationPanel = (function () {
  ...
  // MW - make available out of method
  Conversation.isUser = false;
  Conversation.mwDispMsg = function(msg) {
    var settings = {
      selectors: {
    ...
    if (Conversation.isUser) var msg = {input:{text:msg}};
    else var msg = {output:{generic:[{response_type:'text', text:msg}] }};
    displayMessage(msg, Conversation.isUser?settings.authorTypes.user:settings.authorTypes.watson);
  ...
  function displayMessage(newPayload, typeValue) {
    ...
    if ((newPayload.output && newPayload.output.generic) ||  newPayload.input){
      ...
      // Conversation.chatBoxElement = document.querySelector(settings.selectors.chatBox); // mw
